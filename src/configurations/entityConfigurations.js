...
export const paddleConfig = {
  ...
  get startY() {
	...
	type: 'paddle',
	sections: [
		{ start: 0, end: sectionWidth, dx: -350 },
		{ start: sectionWidth, end: sectionWidth * 2, dx: -250 },
		{ start: sectionWidth * 2, end: sectionWidth * 3, dx: -150 },
		{ start: sectionWidth * 3, end: sectionWidth * 4, dx: -50 },
		{ start: sectionWidth * 4, end: sectionWidth * 5, dx: 0 },
		{ start: sectionWidth * 5, end: sectionWidth * 6, dx: 50 },
		{ start: sectionWidth * 6, end: sectionWidth * 7, dx: 150 },
		{ start: sectionWidth * 7, end: sectionWidth * 8, dx: 250 },
		{ start: sectionWidth * 8, end: paddleWidth, dx: 350 },
	],
	collisionObjects: [
		'leftWall',
		'rightWall',
